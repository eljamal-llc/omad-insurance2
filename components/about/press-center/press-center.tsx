...
import { PressStenterProps } from "./press-center.t";
...
const PressCenter: FC<PressStenterProps> = ({title,description}) => {
    ...
    <MissionBody>
      <MissionContent>
        <div>
          ...
          <FinancialBlockTitle>Информация для подаци заявок</FinancialBlockTitle>
          ...
          <RulesSearch
              ...
              label={t('Найти Статью')}
              type={'search'}
            />
            <Pravila>№ 3 Правила добровольного медицинского страхования</Pravila>
            <BlockDocs>
                <div>
