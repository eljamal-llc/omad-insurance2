...
import { FinancialYears ,FinancialBlock, FinancialBlockTitle, FinicialBloclContent, DownloadBlock, FinicialP, DwBtnBlock, DwBlockBorder} from "../financial-performance/financial-performance.e";
...
const Partners: FC<PartnersProps> = ({title,description}) => {
      ...
      <MissionContent>
          <div>
                <SponsrBlock>
                    ...
                    <SponsorTitle>Russian Automotive Marker Research <br/> (НАПИ)</SponsorTitle>
                    <SponsorTitleItem>Аналитическое автомобильное агентство (с 1995г)
                        представляет новый продукт: КАЛЬКУЛЯТОР СТОИМОСТИ ВЛАДЕНИЯ АВТОМОБИЛЕЙ (ТСО) по легковым автомобилям, грузовым автомобилям, LCV: https://dv-tco.ru/ <br/><br/>
                        Стоимость владения - сумма расходов на эксплуатацию автомобиля и потери стоимости автомобиля за период владения.<br/><br/>
                        Стоимость владения рассчитывается на конкретную модель автомобиля. Размер расходов на автомобиль зависит от технических характеристик автомобиля, региона регистрации владельца автомобиля и др.
                        </SponsorTitleItem>
                    </div>
